...
class GlobalSymbolsAdapter(context: Context, symbolList : ArrayList<SymbolModel>, val clickListener: (SymbolModel) -> Unit): RecyclerView.Adapter<GlobalSymbolsAdapter.MyViewHolder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): GlobalSymbolsAdapter.MyViewHolder {
    ...
    override fun onBindViewHolder(holder: GlobalSymbolsAdapter.MyViewHolder, position: Int) {
